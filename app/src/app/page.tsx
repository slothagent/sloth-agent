      ...
      <Header />
        ...
        <div className="flex gap-4  max-h-[700px] ">
          ...
          <div className="w-full  md:w-[400px] max-h-[700px] bg-[#F7F7F7]  border-2">
              ...
              <div className="rounded-lg w-full h-[600px] relative">
                <div className="w-full h-full relative rounded-lg overflow-hidden">
                  ...
                  />
                  {/* Overlay Text */}
                  <div className="absolute bottom-0 left-0 right-0 p-10 bg-gradient-to-t from-[#a195c2] to-transparent">
          ...
          <div className="flex-1 flex flex-col justify-between ">
              ...
              <div className="  mb-8">
                <div className="">
                  <input
                    ...
                    className="w-full bg-black/20 rounded-lg px-4 py-2 text-white placeholder-gray-400"
                    value={searchQuery}
              ...
              {/* Featured Print */}
              <div className=" mb-12">
                <h1 className="text-6xl font-bold mb-4 ">GET YOUR<br />FREE PRINTS</h1>
                <p className="text-gray-300 mb-8">
                  Choose a meebit and add the print to your bag. Available for a limited time only.
                </p>
                
                <div className="flex gap-4">
                  <button className="bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded-lg transition-colors">
                    ADD ALL PRINTS TO CART
                  </button>
            ...
            {/* Prints Grid*/}
              <div className=" mt-auto">
                <div className="grid grid-cols-4 gap-6 ">
                  {prints.map((print) => (
                    <div key={print.id} className="bg-purple-800/50  rounded-lg p-1 hover:bg-purple-700/50 transition-colors cursor-pointer">
                      <div className="aspect-square relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-[#a195c2] to-transparent">
        ...
        <div className="flex gap-4 mt-8 border-2">
        ...
        <div className="flex gap-4 mt-12 border-neutral-500 border-2">
          <div className="w-full overflow-x-auto">
            <table className="w-full min-w-max table-fixed">
              <colgroup>
                <col className="w-[200px]" /> {/* Token */}
