            ...
            <div className="border-[#1F2937]">
                ...
                <Tabs defaultValue="trade" className="w-full">
                    ...
                    <TabsContent value="launching" className="mt-4">
                        <Launching totalMarketCap={parseFloat(totalMarketCap?.toString()||"0")} totalSupply={parseFloat(totalSupply?.toString()||"0")} symbol={tokenData?.ticker||''} transactions={transactionHistory as any|| []} bondingCurveAddress={tokenData?.curveAddress||''} tokenAddress={tokenData?.address||''} network={tokenData?.network||''} sonicPrice={sonicPrice} ethPrice={ethPrice} />
                    </TabsContent>
                </Tabs>
                </div>
            </div>
