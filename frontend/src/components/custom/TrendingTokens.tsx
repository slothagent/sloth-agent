    ...
    <div>
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <select 
            className="bg-[#1C2333] text-white border border-gray-700 rounded-none px-2 py-1 text-sm"
            value={sortBy}
      ...
      <Card className="bg-[#161B28] border-none rounded-none overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-800">
          ...
          <div className="flex items-center gap-4">
            <Button
              variant="outline"
              className="text-gray-400 hover:bg-[#1C2333] hover:text-white rounded-none bg-transparent cursor-pointer"
