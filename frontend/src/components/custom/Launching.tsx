                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="flex justify-between items-center w-full gap-2">
                                ...
                                <a href={`https://testnet.sonicscan.org/address/${bondingCurveAddress}`} target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-white text-sm">{formatAddress(bondingCurveAddress)}</a>
                                <Badge variant="outline" className="bg-[#93E905]/10 px-0 md:px-2.5 text-xs text-nowrap text-[#93E905] border-[#93E905]">
                                    Bonding Curve
                                </Badge>
